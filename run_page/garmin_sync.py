...
class Garmin:
    ...
    def _refresh_with_retry_sync(self, max_retries=5, base_delay=10):
        """Synchronous retry for use when event loop may already be running."""
